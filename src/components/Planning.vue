                        ...
                        <tr v-for="week in weeks">
                            <td v-for="day in week">
                                <div class="day-print" :class="{
                                    'justify-start': getDecoration(day.date, 1) && !getCustomPlanning(day.date),
                                    'justify-end': getDecoration(day.date, 2) && !getCustomPlanning(day.date),
                                    'justify-center': (!getDecoration(day.date, 1) && !getDecoration(day.date, 2)) || getCustomPlanning(day.date),
                                }">
                                    ...
                                    <div class="anim-list" :class="{ 'custom': getCustomPlanning(day.date) }"
                                        :data-nb="`${getAnimationsPlanning(day.date).length}`">
                                        <div v-if="!getCustomPlanning(day.date)" class="anim"
                                            v-for="anim in getAnimationsPlanning(day.date)" :key="anim.id">
